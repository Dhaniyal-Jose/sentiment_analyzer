...
model.fit(X_train, y_train, epochs=10, batch_size=32, validation_data=(X_test, y_test), class_weight=class_weights_dict, callbacks=[lr_scheduler])

# Save the model
model.save('C:/Users/dhani/Downloads/sentiment_analyzer/models/sentiment_model_v3.h5')

print("Model training complete and saved to C:/Users/dhani/Downloads/sentiment_analyzer/models/sentiment_model_v3.h5")
